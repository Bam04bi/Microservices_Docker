...
public class VoitureApplication {
    ...
    CommandLineRunner initialiserBaseMySQL(VoitureRepository voitureRepository, ClientService clientService){
        return args -> {
            ...
            voitureRepository.save(new Voiture(Long.parseLong("1"), "Aston Martin", "1485BBH", "db15", c2.getId()));
            voitureRepository.save(new Voiture(Long.parseLong("2"), "Mercedes", "G63", "AMG", c2.getId()));
            voitureRepository.save(new Voiture(Long.parseLong("3"), "Mercedes", "R1236", "GLS", c1.getId()));
